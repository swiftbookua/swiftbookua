...
Інструкцію узагальнення `where` можна використовувати як частину оголошення, що не має власних обмежень типів, коли ви уже працюєте у контексті узагальненого типу. Наприклад, інструкцію узагальнення  `where` можна вказати на індексі узагальненого типу, або на методі у розширенні узагальненого типу. Структура  `Container` у прикладі нижче є узагальненою, і інструкція узагальнення `where` вказує, які обмеження типу мають задовільнятись, аби ці нові методи були доступними на її екземплярах.

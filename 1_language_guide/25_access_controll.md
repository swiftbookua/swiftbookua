...
Як описано у підрозділі [Ініціалізатори за замовчанням](13_initialization#Ініціалізатори-за-замовчанням), Swift автоматично створює _ініціалізатори за замовчанням_ без жодних аргументів для будь-якої структури чи базового класу, що має значення за замовчанням для всіх властивостей та не має хоча б одного явного ініціалізатора.

...
Операція є атомарною, якщо вона використовує лише атомарні операції мови C, в інших випадках операція не є атомарною. Список цих функції можна знайти на man-сторінці `stdatomic(3)`.

...
- Додано інформацію про асинхронні функції, задачі та актори до розділу [Конкурентність]({% link _book/1_language_guide/16_5_concurrency.md %}), and to the <doc:Declarations#Actor-Declaration>, <doc:Declarations#Asynchronous-Functions-and-Methods> and <doc:Expressions#Await-Operator> sections.
